...
![npm](https://img.shields.io/npm/v/ai-vercel-config)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-vercel-config)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Vercel configuration optimization and utilities

Vercel configuration generator. Creates optimized deployment configurations.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-vercel-config.svg)](https://badge.fury.io/js/ai-vercel-config)
